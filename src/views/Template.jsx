...
export const Template = () => {
  ...
  const get = async () => {
    await getTemplate("9c1f94bc-73d7-4705-b95e-c826eef497b1");
  };
  const post = async () => {
    await postTemplate({ column1: "pepe", column2: "juan" });
  };
  const del = async () => {
    await delTemplate("9c1f94bc-73d7-4705-b95e-c826eef497b1");
  };
  const patch = async () => {
    await patchTemplate(
